                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <input type="text" name="addr[billing][state]" placeholder="region/state">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="select-items">
                                                    <x-form.select label='Country' name="addr[billing][country]" :options='$country' />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Region/State</label>
                                                <div class="form-input form">
                                                    <input type="text" name="addr[shipping][state]" placeholder="region/state">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                {{-- <label>Country</label> --}}
                                                <div class="select-items">
                                                    <x-form.select label='Country' name="addr[shipping][country]" :options='$country' />
                                                </div>
                                            </div>
                                        </div>
